...
def porq():
    ...
    facebook_accounts = campaigns.loc[campaigns['campanha'].str.lower() == campaign, 'facebook'].values[0].split(',') if campaigns.loc[campaigns['campanha'].str.lower() == campaign, 'facebook'].values[0] else False
    google_accounts = campaigns.loc[campaigns['campanha'].str.lower() == campaign, 'google'].values[0].split(',') if campaigns.loc[campaigns['campanha'].str.lower() == campaign, 'google'].values[0] else False
    tiktok_accounts = campaigns.loc[campaigns['campanha'].str.lower() == campaign, 'tiktok'].values[0].split(',') if campaigns.loc[campaigns['campanha'].str.lower() == campaign, 'tiktok'].values[0] else False
    linkedin_accounts = campaigns.loc[campaigns['campanha'].str.lower() == campaign, 'linkedin'].values[0].split(',') if campaigns.loc[campaigns['campanha'].str.lower() == campaign, 'linkedin'].values[0] else False
    twitter_campaigns = campaigns.loc[campaigns['campanha'].str.lower() == campaign, 'twitter'].values[0].split(',') if campaigns.loc[campaigns['campanha'].str.lower() == campaign, 'twitter'].values[0] else False
    cm_campaigns = campaigns.loc[campaigns['campanha'].str.lower() == campaign, 'campaign_manager'].values[0].split(',') if campaigns.loc[campaigns['campanha'].str.lower() == campaign, 'campaign_manager'].values[0] else False
